...
namespace MoneyFox.Core.Interfaces
{
    public interface IGenericDataRepository<T> where T : class
    {
        ...
        ///     Filter can also be null. Then all items will returned.
        /// </summary>
        /// <param name="filter">Filter Expression.</param>
        /// <param name="navigationProperties">Associations to load.</param>
        /// <returns>List with loaded items.</returns>
        IList<T> GetList(Expression<Func<T, bool>> filter = null, params Expression<Func<T, object>>[] navigationProperties);
