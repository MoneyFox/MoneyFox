...
namespace MoneyFox.Core.SettingAccess
{
    ...
    public class Settings
    {
        ...
        private static ILocalSettings LocalSettings => ServiceLocator.Current.GetInstance<ILocalSettings>();
        private static IRoamingSettings RoamingSettings => ServiceLocator.Current.GetInstance<IRoamingSettings>();
