...
namespace MoneyFox.Domain.Exceptions
{
    ...
    public class ExtendedFormatException : Exception
    {
        ...
        public ExtendedFormatException(string message) : base(GetMessageWithRegionInfo(message, string.Empty))
        {
        }
        ...
        public ExtendedFormatException(Exception exception, string textToParse) : base(GetMessageWithRegionInfo(exception?.Message ?? string.Empty,
                                                                                                                textToParse),
                                                                                       exception)
        {
        }
        ...
        {
            return $"Text to parse: {textToParse}{Environment.NewLine}Region: {CultureInfo.CurrentCulture.DisplayName}{Environment.NewLine}CultureName: {CultureInfo.CurrentCulture.Name}{Environment.NewLine}Numberformat: {CultureInfo.CurrentCulture.NumberFormat}{Environment.NewLine}{message}";
        }
    }
}
