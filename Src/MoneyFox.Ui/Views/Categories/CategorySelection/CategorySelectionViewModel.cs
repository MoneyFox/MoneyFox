...
internal sealed class CategorySelectionViewModel : BasePageViewModel, IRecipient<CategoriesChangedMessage>
{
    private readonly IDialogService dialogService;
    private readonly IMapper mapper;
    private readonly IMediator mediator;

    public CategorySelectionViewModel(IDialogService dialogService, IMapper mapper, IMediator mediator)
    {
