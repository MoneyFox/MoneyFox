    ...
    public static class ThemeManager
    {
        ...
        public static void ChangeTheme(AppTheme theme)
        {
            ...
            if(mergedDictionaries != null)
            {
                ...
                ((NavigationPage)Xamarin.Forms.Application.Current.MainPage).BarBackgroundColor = (Color)Xamarin.Forms.Application.Current.Resources["AppBarColor"];
                ((NavigationPage)Xamarin.Forms.Application.Current.MainPage).BarTextColor = (Color)Xamarin.Forms.Application.Current.Resources["PrimaryFontColor"];
            }
        }
