...
namespace MoneyFox.iOS
{
    ...
    public class LinkerPleaseInclude
    {
        ...
        public void Include(INotifyCollectionChanged changed) => changed.CollectionChanged += (s, e) =>
        {
            var test = $"{e.Action}{e.NewItems}{e.NewStartingIndex}{e.OldItems}{e.OldStartingIndex}";
        };

        public void Include(ICommand command) => command.CanExecuteChanged += (s, e) =>
        {
        ...
        public void Include(INotifyPropertyChanged changed) => changed.PropertyChanged += (sender, e) =>
        {
