...
namespace MoneyManager.Droid
{
    public class ViewModelLocator
    {
        ...
        private static INavigationService CreateNavigationService()
        {
            ...
            navigationService.Configure("AddAccountView", typeof (AddAccountActivity));
            navigationService.Configure("AddTransactionActivity", typeof (AddTransactionActivity));
            navigationService.Configure("SelectCategoryView", typeof (SelectCategoryActivity));
