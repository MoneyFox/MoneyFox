...
{
    public class MyEditPaymentView : ReactiveView<EditPaymentViewModel> { }
    ...
    public sealed partial class EditPaymentView
    {
        public EditPaymentView()
        {
            ...
            this.WhenActivated(disposable =>
            {
                ...
                this.OneWayBind(ViewModel, vm => vm.DeleteCommand, v => v.DeleteButton.Command).DisposeWith(disposable);
                this.OneWayBind(ViewModel, vm => vm.Resources["DeleteLabel"], v => v.DeleteButton.Label).DisposeWith(disposable);
            });
        }
    }
}
