    ...
    public sealed partial class EditPaymentView
    {
        public EditPaymentView()
        {
            ...
            this.WhenActivated(disposable =>
            {
                ...
                this.Bind(ViewModel, vm => vm.DeleteCommand, v => v.DeleteButton.Command).DisposeWith(disposable);
                this.Bind(ViewModel, vm => vm.Resources["DeleteLabel"], v => v.DeleteButton.Label).DisposeWith(disposable);
            });
        }
    }
}
