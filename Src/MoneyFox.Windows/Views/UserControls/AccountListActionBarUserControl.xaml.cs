...
namespace MoneyFox.Windows.Views.UserControls
{
    ...
    public sealed partial class AccountListActionBarUserControl
    {
        public AccountListActionBarUserControl() {
            ...
            {
                this.OneWayBind(ViewModel, vm => vm.GoToAddIncomeCommand, v => v.AddIncomeButton.Command)
                    .DisposeWith(disposables);
                this.OneWayBind(ViewModel, vm => vm.GoToAddExpenseCommand, v => v.AddExpenseButton.Command)
                    .DisposeWith(disposables);
                this.OneWayBind(ViewModel, vm => vm.GoToAddTransferCommand, v => v.AddTransferButton.Command)
                    .DisposeWith(disposables);
                this.OneWayBind(ViewModel, vm => vm.GoToAddAccountCommand, v => v.AddAccountButton.Command)
                    .DisposeWith(disposables);
