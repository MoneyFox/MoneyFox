...
public class GetCashFlowQueryHandlerTests : IDisposable
{
    ...
    public async Task GetValues_CorrectSums()
    {
        ...
        context.AddRange(
            new List<Payment>
            {
                new(DateTime.Today, 60, PaymentType.Income, new Account("Foo1")),
                new(DateTime.Today, 20, PaymentType.Income, new Account("Foo2")),
                new(DateTime.Today, 50, PaymentType.Expense, new Account("Foo3")),
                new(DateTime.Today, 40, PaymentType.Expense, new Account("Foo3"))
            });
        context.SaveChanges();
    ...
    public async Task GetValues_CorrectNegativeSign(string culture, int indexNegativeSign, char expectedNegativeSign)
    {
        ...
        context.AddRange(new List<Payment> {new(DateTime.Today, 40, PaymentType.Expense, new Account("Foo3"))});
        context.SaveChanges();
