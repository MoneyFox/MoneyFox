...
namespace MoneyFox.Foundation.Groups
{
    public class DateListGroupCollection<T> : List<T>
    {
        ...
        public DateListGroupCollection(string key, ReactiveCommand<T, Unit> itemClickCommand = null)
        {
            Key = key;
        ...
        public static List<DateListGroupCollection<T>> CreateGroups(IEnumerable<T> items, GetKeyDelegate getKey,
            GetSortKeyDelegate getSortKey, bool sort = true, ReactiveCommand<T, Unit> itemClickCommand = null)
        {
